### maintainers-convention - Pattern matching for modern JavaScript
...
<!-- [![Downloads](http://img.shields.io/npm/dm/maintainers-convention.svg)](https://www.npmjs.com/package/maintainers-convention)
![NPM](https://nodei.co/npm/maintainers-convention.png?downloadRank=true) ![NPM](https://nodei.co/npm-dl/maintainers-convention.png?months=3&height=2)
-->
